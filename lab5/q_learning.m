function Q = q_learning(map,q_goal,alpha,gamma,epsilon,n_episodes,n_iterations)
    ...
    for i = 1 : size(Q,1)
        for j = 1 : size(Q,2)
            ...
            switch action
                case 1
                    text(j,h + 1 - i,'\uparrow','HorizontalAlignment','center','FontSize',20);
                case 2
                    text(j,h + 1 - i,'\rightarrow','HorizontalAlignment','center','FontSize',20);
                case 3
                    text(j,h + 1 - i,'\downarrow','HorizontalAlignment','center','FontSize',20);
                case 4  
                    text(j,h + 1 - i,'\leftarrow','HorizontalAlignment','center','FontSize',20);
            end
        end
    end
